...
\end{definition}
We write $(G,\sigma) \xrightarrow{\hat\sigma} (G',\sigma')$ when we want to make the reduction substitution explicit.
...
The outcome $(G_0$ \texttt{:-} $G_n)\sigma$ of a proper run $\rho: (G_0,\emptyset) \rightarrow \cdots \rightarrow (G_n, \sigma)$ of $LP(P)$ is a logical consequence of $P$.
\end{restatable}
