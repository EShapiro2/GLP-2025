...
Section~\ref{sec:foundations} recalls the mathematical foundations of grassroots platforms. Section~\ref{sec:lp} recalls logic programs. Section~\ref{sec:glp} extends them to GLP. Section~\ref{sec:maglp} defines multiagent GLP and proves it grassroots. Section~\ref{section:programming-examples} presents basic GLP programming techniques. Section~\ref{section:social-graph} implements the grassroots social graph protocols. Section~\ref{section:implementation} discusses implementation. Section~\ref{section:related-work} reviews related work, and Section~\ref{section:conclusion} concludes.
