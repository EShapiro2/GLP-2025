...
agent(Id, [msg(From, Id1, intro(Other, Ch))|In], Fs) :-
    Id? =?= Id1?, ground(Other?) |
    lookup_send(user, msg(agent, user, befriend_intro(From?, Other?, Ch?)),
        Fs?, Fs1),
    agent(Id?, In?, Fs1?).
...
%% Bob -> Alice
network3(
    ch(AliceIn, [msg(alice, X?)|AliceOut?]),
